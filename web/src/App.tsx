  ...
  useEffect(() => {
    ...
    const checkConnection = async () => {
      try {
        ...
        // Καλύτερη ανίχνευση τύπου σφάλματος
        if (error instanceof TypeError && error.message.includes('Failed to fetch')) {
          setConnectionError('Cannot connect to API server. Make sure it is running at http://localhost:8000');
    ...
    // Retry connection periodically if it failed with exponential backoff
