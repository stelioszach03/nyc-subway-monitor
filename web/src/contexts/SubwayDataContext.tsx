...
export const SubwayDataProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Fetch metrics data - endpoint changed from /metrics to /subway-metrics
  ...
  useEffect(() => {
    ...
    // Increased polling intervals to reduce load
    ...
    const trainInterval = setInterval(fetchTrains, 120000); // Every 2 minutes as backup
